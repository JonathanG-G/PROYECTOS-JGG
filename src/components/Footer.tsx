...
export default function Footer() {
  ...
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=Hola%20Mudanzas%20La%20Ca%C3%B1ada%2C%20quisiera%20solicitar%20un%20presupuesto.`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start space-x-3.5">
                ...
                <div>
                  <p className="font-bold text-slate-100">0351 152-345678</p>
              ...
              <div className="flex items-start space-x-3.5">
                ...
                <div>
                  <p className="font-bold text-slate-100">contacto@mudanzaslacanada.com.ar</p>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 text-xs text-slate-500 font-medium">
          <div className="mb-4 sm:mb-0 text-center sm:text-left">
            <p>© {currentYear} Fletes y Mudanzas La Cañada. Córdoba, Argentina. Todos los derechos reservados.</p>
