...
export default function Header() {
  ...
  const whatsappNumber = "5493516828397"; // WhatsApp number Córdoba (351 682-8397)
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=Hola%20Fletes%20y%20Mudanzas%20Mariano%2C%20quisiera%20consultar%20por%20un%20servicio%20de%20mudanza/flete.`;
